...
const CoachTopbar = ({ toggleSidebar, isSidebarOpen }) => {
  return (
    <motion.div
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-gray-400 text-xs">Panel de Entrenador</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            <div className="hidden sm:block text-right">
              <p className="text-white font-medium text-sm">Coach</p>
              <p className="text-gray-400 text-xs">Entrenador Personal</p>
            </div>
